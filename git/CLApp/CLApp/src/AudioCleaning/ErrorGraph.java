...
public class ErrorGraph {
	...
	public static void selectionSyncronization(double[] f, double[] s, int winLen){
		...
		matrix.matrix[0][0]=CleaningAlgorithm.xcross(f, f , offset);
		matrix.matrix[0][1]=CleaningAlgorithm.xcross(f, s, offset);
		matrix.matrix[1][0]=CleaningAlgorithm.xcross(s, f , offset);
		matrix.matrix[1][1]=CleaningAlgorithm.xcross(s, s, offset);
	...
	public static void main(String[] args){
		...
		CleaningAlgorithm.save("error.wav", f);
